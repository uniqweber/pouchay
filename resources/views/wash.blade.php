        ...
        <section class="py-20">
            <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <!-- এক্সটেরিয়র ওয়াশ -->
                    <div class="rounded-lg border p-4 bg-white  hover:shadow-md transition">
                        <div class="flex items-center gap-4 mb-3">
                            ...
                            <h3 class="text-lg font-semibold text-gray-800">এক্সটেরিয়র ওয়াশ</h3>
                        </div>
                        <p class="text-sm text-gray-600 mb-3">
                            আপনার গাড়ির বাইরের অংশে ময়লা, ধুলো ও দাগ দূর করে ঝকঝকে করে তুলি খুব যত্নে।
                        </p>
                        <div class="flex items-end justify-between mt-auto">
                            <span class="font-bold text-gray-800">৳৩৫০</span>
                    ...
                    <div class="rounded-lg border p-4 bg-white  hover:shadow-md transition">
                        <div class="flex items-center gap-4 mb-3">
                            ...
                            <h3 class="text-lg font-semibold text-gray-800">ইঞ্জিন ওয়াশ</h3>
                        </div>
                        <p class="text-sm text-gray-600 mb-3">
                            ইঞ্জিন ক্লিনিং এর মাধ্যমে গরম হওয়া রোধ করি এবং ইঞ্জিন পারফর্মেন্স ধরে রাখি।
                        </p>
                        <div class="flex items-end justify-between mt-auto">
                            <span class="font-bold text-gray-800">৳৫৫০</span>
                    ...
                    <div class="rounded-lg border p-4 bg-white  hover:shadow-md transition">
                        <div class="flex items-center gap-4 mb-3">
                            ...
                            <h3 class="text-lg font-semibold text-gray-800">ইনটেরিয়র ক্লিনিং</h3>
                        </div>
                        <p class="text-sm text-gray-600 mb-3">
                            সিট, দরজা, কার্পেট এবং ড্যাশবোর্ড পরিষ্কার করি যেন আপনার গাড়ির ভিতরটা হয় নতুনের মতো।
                        </p>
                        <div class="flex items-end justify-between mt-auto">
                            <span class="font-bold text-gray-800">৳৪৫০</span>
                    ...
                    <div class="rounded-lg border p-4 bg-white  hover:shadow-md transition">
                        <div class="flex items-center gap-4 mb-3">
                            ...
                            <h3 class="text-lg font-semibold text-gray-800">এসি সার্ভিসিং</h3>
                        </div>
                        <p class="text-sm text-gray-600 mb-3">
                            এসি ফিল্টার ক্লিনিং, কুলিং চেকআপ এবং গ্যাস টপ-আপসহ সম্পূর্ণ সার্ভিসিং ঘরে বসেই পাই।
                        </p>
                        <div class="flex items-end justify-between mt-auto">
                            <span class="font-bold text-gray-800">৳৭৫০</span>
                    ...
                    <div class="rounded-lg border p-4 bg-white  hover:shadow-md transition">
                        <div class="flex items-center gap-4 mb-3">
                            ...
                            <h3 class="text-lg font-semibold text-gray-800">এসি ইনস্টলেশন</h3>
                        </div>
                        <p class="text-sm text-gray-600 mb-3">
                            নতুন এসি সেটআপ, পুরনো এসি রিলোকেশন — আমরা সব ইনস্টলেশন করি দক্ষতায় ও সঠিকতায়।
                        </p>
                        <div class="flex items-end justify-between mt-auto">
                            <span class="font-bold text-gray-800">৳১২০০</span>
                    ...
                    <div class="rounded-lg border p-4 bg-white  hover:shadow-md transition">
                        <div class="flex items-center gap-4 mb-3">
                            ...
                            <h3 class="text-lg font-semibold text-gray-800">এসি গ্যাস রিফিল</h3>
                        </div>
                        <p class="text-sm text-gray-600 mb-3">
                            এসির কুলিং সমস্যা সমাধানে নির্ভুল গ্যাস রিফিল সার্ভিস, ঘরে বসেই দ্রুত পেয়ে যান।
                        </p>
                        <div class="flex items-end justify-between mt-auto">
                            <span class="font-bold text-gray-800">৳১৩০০</span>
                    ...
                    <div class="rounded-lg border p-4 bg-white  hover:shadow-md transition">
                        <div class="flex items-center gap-4 mb-3">
                            ...
                            <h3 class="text-lg font-semibold text-gray-800">কম্পিউটার রিপেয়ার</h3>
                        </div>
                        <p class="text-sm text-gray-600 mb-3">
                            ডিসপ্লে, পাওয়ার, হার্ডড্রাইভ বা সফটওয়্যার সমস্যা? টেক এক্সপার্ট বাসায় গিয়ে ঠিক করে।
                        </p>
                        <div class="flex items-end justify-between mt-auto">
                            <span class="font-bold text-gray-800">৳৫০০+</span>
                    ...
                    <div class="rounded-lg border p-4 bg-white  hover:shadow-md transition">
                        <div class="flex items-center gap-4 mb-3">
                            ...
                            <h3 class="text-lg font-semibold text-gray-800">ল্যাপটপ সার্ভিসিং</h3>
                        </div>
                        <p class="text-sm text-gray-600 mb-3">
                            স্লো ল্যাপটপ, গরম হওয়া, ফ্যানে ধুলো জমা — আমরা দিই ফুল হার্ডওয়্যার ক্লিনিং সার্ভিস।
                        </p>
                        <div class="flex items-end justify-between mt-auto">
                            <span class="font-bold text-gray-800">৳৬০০+</span>
                    ...
                    <div class="rounded-lg border p-4 bg-white  hover:shadow-md transition">
                        <div class="flex items-center gap-4 mb-3">
                            ...
                            <h3 class="text-lg font-semibold text-gray-800">সফটওয়্যার সেটআপ</h3>
                        </div>
                        <p class="text-sm text-gray-600 mb-3">
