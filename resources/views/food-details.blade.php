...
<body class="font-noto-bengali dark:bg-gray-900">
    <x-shared.navbar />
    <!-- banner -->
    ...
    <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8  py-20">
        <div>
            <h2 class="flex items-center mb-7 gap-2 text-xl font-semibold dark:text-white"> <i class="ti ti-chef-hat"></i> আমাদের খাবার রেস্টুরেন্টের খাবার সমূহ </h2>
