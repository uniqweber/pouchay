...
<body class="font-noto-bengali">
    ...
    <div class="min-h-screen bg-white">
        ...
        <section id="home" class="pt-36 pb-20 bg-white dark:bg-gray-900 ">
                ...
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div class="space-y-8">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            ...
                            <button class="px-8 py-4 border-2 border-gray-300 text-gray-700  dark:text-white dark:border-gray-600 rounded-xl font-semibold hover:border-blue-600 hover:text-blue-600 transition-colors">
                                আরও জানুন
                            </button>
                        </div>
                        ...
                        <div class="flex items-center space-x-8">
                            <div class="text-center">
                                ...
                                <div class="text-gray-600 dark:text-gray-400">সন্তুষ্ট গ্রাহক</div>
                            </div>
                            <div class="text-center">
                                <div class="text-3xl font-bold text-purple-600">২৪/৭</div>
                                <div class="text-gray-600 dark:text-gray-400">সেবা প্রদান</div>
                            </div>
                            <div class="text-center">
                                <div class="text-3xl font-bold text-green-600">৯৮%</div>
                                <div class="text-gray-600 dark:text-gray-400">সফলতার হার</div>
                            </div>
                        </div>
                    </div>
        ...
        <section id="services" class="py-20 bg-white dark:bg-gray-900">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    <h2 class="text-4xl font-bold text-gray-900 dark:text-white mb-4">আমাদের সেবাসমূহ</h2>
        ...
        <section class="py-20 bg-white dark:bg-gray-900">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div class="space-y-8">
                        <div class="space-y-4">
                            <h2 class="text-4xl font-bold dark:text-white text-gray-900">গাড়ি ও বাইক ধোয়ার সেবা</h2>
                        ...
                        <div class="grid sm:grid-cols-2 gap-6">
                            <div class="flex items-start space-x-3">
                                <i class="ti ti-circle-check dark:text-white text-2xl mt-1"></i>
                                <div>
                                    <h4 class="font-semibold text-gray-900 dark:text-white">বাহ্যিক ধোয়া</h4>
                                    <p class="dark:text-gray-400 text-gray-600">সম্পূর্ণ বাহ্যিক পরিষ্কার</p>
                                </div>
                            </div>
                            <div class="flex items-start space-x-3">
                                <i class="ti ti-circle-check dark:text-white text-2xl mt-1"></i>
                                <div>
                                    <h4 class="font-semibold text-gray-900 dark:text-white">অভ্যন্তরীণ পরিষ্কার</h4>
                                    <p class="dark:text-gray-400 text-gray-600">ভিতরের সম্পূর্ণ পরিষ্কার</p>
                                </div>
                            </div>
                            <div class="flex items-start space-x-3">
                                <i class="ti ti-circle-check dark:text-white text-2xl mt-1"></i>
                                <div>
                                    <h4 class="font-semibold text-gray-900 dark:text-white">ওয়াক্স পলিশ</h4>
                                    <p class="dark:text-gray-400 text-gray-600">চকচকে ফিনিশিং</p>
                                </div>
                            </div>
                            <div class="flex items-start space-x-3">
                                <i class="ti ti-circle-check dark:text-white text-2xl mt-1"></i>
                                <div>
                                    <h4 class="font-semibold text-gray-900 dark:text-white">হোম সার্ভিস</h4>
                                    <p class="dark:text-gray-400 text-gray-600">আপনার বাড়িতেই সেবা</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="space-y-8 order-1 lg:order-2">
                        <div class="space-y-4">
                            <h2 class="text-4xl font-bold text-gray-900 dark:text-white">ইলেকট্রনিক্স সার্ভিস</h2>
                            <p class="text-lg text-gray-600 dark:text-gray-400">
        ...
        <section class="py-20 bg-white dark:bg-gray-900">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div class="space-y-8">
                        <div class="space-y-4">
                            <h2 class="text-4xl font-bold text-gray-900 dark:text-white">এসি সার্ভিস ও মেরামত</h2>
                            <p class="text-lg text-gray-600 dark:text-gray-400">
                        ...
                        <div class="grid sm:grid-cols-2 gap-4">
                            <div class="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm">
                                ...
                                <h4 class="font-semibold text-gray-900 dark:text-white mt-2">ইনস্টলেশন</h4>
                                <p class="text-gray-600 dark:text-gray-400">নতুন এসি বসানো</p>
                            </div>
                            <div class="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm">
                                <i class="ti ti-thermometer text-4xl text-green-600 "></i>
                                <h4 class="font-semibold text-gray-900 dark:text-white mt-2">মেরামত</h4>
                                <p class="text-gray-600 dark:text-gray-400">যেকোনো সমস্যার সমাধান</p>
                            </div>
                            <div class="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm">
                                <i class="ti ti-shield-check text-4xl text-green-600 "></i>
                                <h4 class="font-semibold text-gray-900 dark:text-white mt-2">রক্ষণাবেক্ষণ</h4>
                                <p class="text-gray-600 dark:text-gray-400">নিয়মিত সার্ভিসিং</p>
                            </div>
                            <div class="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm">
                                <i class="ti ti-clock text-4xl text-green-600 "></i>
                                <h4 class="font-semibold text-gray-900 dark:text-white mt-2">জরুরি সেবা</h4>
                                <p class="text-gray-600 dark:text-gray-400">২৪/৭ জরুরি সেবা</p>
                            </div>
                        </div>
        ...
        <section class="py-20 bg-white dark:bg-gray-900">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="space-y-8 order-1 lg:order-2">
                        <div class="space-y-4">
                            <h2 class="text-4xl font-bold text-gray-900 dark:text-white">খাবার ডেলিভারি সেবা</h2>
                            <p class="text-lg text-gray-600 dark:text-gray-400">
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <h4 class="font-semibold dark:text-white text-gray-900 mb-1">বিভিন্ন ধরনের খাবার</h4>
                                    <p class="text-gray-600 dark:text-gray-400">বাংলা, চাইনিজ, ফাস্ট ফুড এবং স্বাস্থ্যকর খাবার</p>
                                </div>
                            </div>
                            <div class="flex items-start space-x-4">
                                <div class="w-12 h-12 bg-orange-100 rounded-xl flex items-center justify-center">
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-900 dark:text-white mb-1">দ্রুত ডেলিভারি</h4>
                                    <p class="text-gray-600 dark:text-gray-400">৩০-৪৫ মিনিটের মধ্যে আপনার কাছে পৌঁছে যাবে</p>
                                </div>
                            </div>
                            <div class="flex items-start space-x-4">
                                <div class="w-12 h-12 bg-orange-100 rounded-xl flex items-center justify-center">
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-900 dark:text-white mb-1">তাজা ও স্বাস্থ্যকর</h4>
                                    <p class="text-gray-600 dark:text-gray-400">সব খাবার তাজা উপাদান দিয়ে তৈরি</p>
                                </div>
                            </div>
                        </div>
        ...
        <section id="about" class="py-20 bg-white dark:bg-gray-900">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    <h2 class="text-4xl font-bold text-gray-900 dark:text-white mb-4">কেন আমাদের বেছে নেবেন?</h2>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div class="text-center p-8 bg-white rounded-2xl dark:bg-gray-800 shadow-lg hover:shadow-xl transition-shadow">
                        <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-6">
                            <i class="ti ti-users text-2xl text-blue-600 "></i>
                        </div>
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-4">অভিজ্ঞ টিম</h3>
                        <p class="dark:text-gray-400 text-gray-600">আমাদের রয়েছে দক্ষ ও অভিজ্ঞ পেশাদার টিম যারা সর্বোচ্চ মানের সেবা প্রদান করে</p>
                    </div>
                    ...
                    <div class="text-center p-8 bg-white rounded-2xl dark:bg-gray-800 shadow-lg hover:shadow-xl transition-shadow">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-4">সময়ানুবর্তিতা</h3>
                        <p class="dark:text-gray-400 text-gray-600">আমরা সময়ের প্রতি অত্যন্ত সচেতন এবং নির্ধারিত সময়ে সেবা প্রদান করি</p>
                    </div>
                    ...
                    <div class="text-center p-8 bg-white rounded-2xl dark:bg-gray-800 shadow-lg hover:shadow-xl transition-shadow">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-4">নির্ভরযোগ্যতা</h3>
                        <p class="dark:text-gray-400 text-gray-600">আমাদের সেবার মান ও নির্ভরযোগ্যতার জন্য আমরা পরিচিত এবং গ্রাহকদের আস্থাভাজন</p>
                    </div>
                    ...
                    <div class="text-center p-8 bg-white rounded-2xl dark:bg-gray-800 shadow-lg hover:shadow-xl transition-shadow">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-4">উন্নত মান</h3>
                        <p class="dark:text-gray-400 text-gray-600">আমরা সর্বদা উন্নত মানের পণ্য ও সেবা প্রদান করি যা আপনার প্রত্যাশা পূরণ করবে</p>
                    </div>
                    ...
                    <div class="text-center p-8 bg-white rounded-2xl dark:bg-gray-800 shadow-lg hover:shadow-xl transition-shadow">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-4">গ্রাহক সেবা</h3>
                        <p class="dark:text-gray-400 text-gray-600">আমাদের গ্রাহক সেবা টিম ২৪/৭ আপনার সেবায় নিয়োজিত এবং যেকোনো সমস্যার সমাধান করে</p>
                    </div>
                    ...
                    <div class="text-center p-8 bg-white rounded-2xl dark:bg-gray-800 shadow-lg hover:shadow-xl transition-shadow">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-4">দ্রুত সেবা</h3>
                        <p class="dark:text-gray-400 text-gray-600">আমরা দ্রুততম সময়ে সেবা প্রদান করি এবং জরুরি প্রয়োজনে তাৎক্ষণিক সেবা দিই</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="contact" class="py-20 bg-white dark:bg-gray-900">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    <h2 class="text-4xl font-bold text-gray-900 dark:text-white mb-4">যোগাযোগ করুন</h2>
                    <p class="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">আমাদের সাথে যোগাযোগ করুন এবং আপনার প্রয়োজনীয় সেবা নিন</p>
                </div>
                ...
                <div class="grid lg:grid-cols-2 gap-12">
                    <div class="space-y-8">
                        <div class="space-y-6">
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-900 dark:text-white mb-2">ফোন নম্বর</h4>
                                    <p class="text-gray-600 dark:text-gray-400">+৮৮০ ১৭১২-৩৪৫৬৭৮</p>
                                    <p class="text-gray-600 dark:text-gray-400">+৮৮০ ১৯১২-৩৪৫৬৭৮</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <h4 class="font-semibold text-gray-900 dark:text-white mb-2">ইমেইল</h4>
                                    <p class="text-gray-600 dark:text-gray-400">info@servicepro.com</p>
                                    <p class="text-gray-600 dark:text-gray-400">support@servicepro.com</p>
                                </div>
                            </div>

                            <div class="flex items-start space-x-4">
                                <div class="w-12 h-12 bg-purple-100 rounded-xl flex items-center justify-center">
                                    <i class="ti ti-map-pin text-2xl text-purple-600 d"></i>
                                </div>
                                <div>
                                    <h4 class="font-semibold text-gray-900 dark:text-white mb-2">ঠিকানা</h4>
                                    <p class="text-gray-600 dark:text-gray-400">১২৩, গুলশান এভিনিউ</p>
                                    <p class="text-gray-600 dark:text-gray-400">ঢাকা-১২১২, বাংলাদেশ</p>
                                </div>
                            </div>
                        </div>

                        <div class="p-6 bg-blue-50 dark:bg-gray-800 rounded-2xl">
                            <h4 class="font-semibold text-gray-900 dark:text-white mb-4">কাজের সময়</h4>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-800 p-8 rounded-2xl">
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">আমাদের বার্তা পাঠান</h3>
                        <form class="space-y-6">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-2">আপনার নাম</label>
                                <input
                                    type="text"
                                    class="w-full dark:border-white/10 dark:bg-gray-700 dark:text-white px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                    placeholder="আপনার পূর্ণ নাম লিখুন" />
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-2">ফোন নম্বর</label>
                                <input
                                    type="tel"
                                    class="w-full dark:border-white/10 dark:bg-gray-700 dark:text-white px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-2">সেবার ধরন</label>
                                <select class="w-full dark:border-white/10 dark:bg-gray-700 dark:text-white px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-400 mb-2">বার্তা</label>
                                <textarea
                                    rows={4}
                                    class="w-full dark:border-white/10 dark:bg-gray-700 dark:text-white px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            ...
                            <button
                                type="submit"
                                class="w-full dark:border-white/10 dark:bg-gray-700 dark:text-white px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-semibold hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300">
                                বার্তা পাঠান
                            </button>
                        </form>
                    </div>
